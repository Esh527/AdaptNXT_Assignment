...
const  PendingTable=()=>{
  ...
  </div>, orderNo: '#TKN20203754', orderDate: '2022-05-04', city: 'Lucknow', customerName: 'Abhisek Dixit', orderValue: 0.00, status: <Button variant="outline-success" style={{ color: '#3EAE4A',borderRadius: '0', borderColor: '#3EAE4A', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>Pending</Button>, Actions: <div class="dropdown">
  <button class="dropbtn">Actions</button></div> },
    { id: 3, icon:"+", checkbox:<input type='checkbox'/>,shoppingIcon:<div>
    <FontAwesomeIcon icon={faShoppingBag} style={{ color: 'green' }} />
  </div>, orderNo: '#TKN20203753', orderDate: '2022-05-04', city: 'Lucknow', customerName: 'Abhisek Dixit', orderValue: 0.00, status: <Button variant="outline-success" style={{ color: '#3EAE4A',borderRadius: '0', borderColor: '#3EAE4A', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>Pending</Button>, Actions: <div class="dropdown">
  <button class="dropbtn">Actions</button></div> },
  { id: 4, icon:"+", checkbox:<input type='checkbox'/>,shoppingIcon:<div>
  <FontAwesomeIcon icon={faShoppingBag} style={{ color: 'green' }} />
</div>, orderNo: '#TKN20203752', orderDate: '2022-05-04', city: 'Lucknow', customerName: 'Abhisek Dixit', orderValue: 0.00, status: <Button variant="outline-success" style={{ color: '#3EAE4A',borderRadius: '0', borderColor: '#3EAE4A', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>Pending</Button>, Actions: <div class="dropdown">
  <button class="dropbtn">Actions</button></div>   },
